    ...
    taxIncentives: [
      {
        ...
        type: 'exemption',
        rate: '0% CIT',
        description: 'Companies with turnover ≤₦50M and fixed assets <₦250M pay no corporate income tax',
        requirements: ['Annual turnover not exceeding ₦50 million', 'Fixed assets below ₦250 million', 'Not a professional service provider'],
      },
    ],
    ediEligible: false,
  },
    ...
    taxIncentives: [
      {
        ...
        duration: '5 years',
        rate: '100% exemption',
        description: 'Complete income tax exemption for the first 5 years from commencement of business',
        requirements: ['Engaged in agricultural business', 'New company or new agricultural venture'],
      },
      {
        name: 'EDI Tax Credit',
        type: 'credit',
        ...
        description: 'Additional 5% annual tax credit on qualifying capital expenditure for agro-processing',
        requirements: ['Minimum qualifying capital expenditure', 'Investment in processing facilities'],
        qceThreshold: 100000000,
      },
    ],
    ediEligible: true,
    ediDetails: 'Agro-processing companies can claim EDI credits on processing equipment, storage facilities, and cold chain infrastructure.',
  },
  {
    id: 'mining',
  ...
  },
  {
    ...
    taxIncentives: [
      ...
      },
      {
        ...
        description: 'Small tech companies (turnover ≤₦50M) exempt from CIT',
